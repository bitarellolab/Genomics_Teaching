...
Hmm, what are all these numbers? This would be a good time to check the documentation for the `wc` program. Type this into your terminal to get some information about what `wc`:
